    ...
    <footer className='bg-[#282828]'>
        ...
        <div className='flex justify-between bg-[#111010cc] w-[100%] text-[white]  px-[1rem] pt-[2.3rem] pb-[4.8rem] max-[960px]:block max-[960px]:p-[1.6rem] ' >
            ...
            <div className='flex  w-[1.6rem] h-[1.6rem] max-[960px]:m-[auto] max-[960px]:my-[2rem]'>
                <img className="mx-[0.4rem] cursor-pointer" src="/productimage/instagram (4).png" alt=""/>
                <img className="mx-[0.4rem] cursor-pointer" src="/productimage/twitter (3).png" alt=""/>
                <img className="mx-[0.4rem] cursor-pointer" src="/productimage/facebook (2).png" alt=""/>
                <img className="mx-[0.4rem] cursor-pointer" src="/E-commerce pictures/youtube.png" alt=""/>
            </div>
            <div className='bg-[#000000b3] px-[0.9rem] pt-[0.3rem] pb-[0.9rem] rounded-[0.3rem] w-[fit-content] max-[960px]:m-[auto] max-[960px]:my-[2rem] '>
                ...
                <div className="flex">
                    {
                        footerImg.map(item=>{
                         return  <div className="flex item-center rounded-[0.3rem] border-[2px] mr-[1rem] border-[white] mg-[0.4rem] cursor-pointer hover:bg-[#ffffff40]">
                                    <div className="h-[1.2rem] ml-[0.1rem] w-[1.2rem] ">
                                        <img src={item.src} alt="sm link"/>
                                    </div>
