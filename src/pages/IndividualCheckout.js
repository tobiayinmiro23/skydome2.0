...
const IndividualCheckout = () => {
    ...
    const { Total } = useSelector(item => item.total)
                ...
                validPayment ?
                    ...
                    <form action="" className='w-[38rem] m-[auto] pt-[4rem] max-[667px]:w-[90%] max-[667px]:pt-[5.3rem]'>
                        ...
                        <div className="text-end">
                            {
                                loading ?
                                    <button disabled className='w-[100%] rounded-[0.2rem] px-[1.2rem] py-[0.4rem] bg-[#38ef7d] font-bold cursor-pointer w-[12rem] h-[4rem] text-[white] outline-none hover:bg-[#17cf5e]'>
                                    ...
                                    :
                                    <button className=' rounded-[0.2rem] px-[1.2rem] py-[0.4rem] bg-[#38ef7d] font-bold cursor-pointer w-[12rem] h-[fit-content] text-[white] outline-none hover:bg-[#17cf5e]'>
